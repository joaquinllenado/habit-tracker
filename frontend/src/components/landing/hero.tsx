...
export default function Hero() {
    return (
        <section className="flex flex-col items-center justify-center w-full h-full mt-32 lg:mt-0 text-center gap-5">
            ...
            <div className="flex flex-row gap-2">
                <Button size="lg" className="hover:bg-purple-500 cursor-pointer">
                    <Link href="/signup">
                        Get Started
                    </Link>
                </Button>
